    ...
    <div className='flex items-center justify-center max-w-7xl mx-auto'>
        <form className='w-1/2 border border-gray-200 rounded-md p-4 my-10' onSubmit={handleSubmit}>
          ...
          <div className='flex items-center gap-2 w-1/2'> 
           ...
           {loading?<Button className='w-full my-4 bg-green-500 text-white hover:bg-green-600'> <Loader2 className='mr-2 h-4 w-4 animate-spin'/>Please wait</Button>: <Button className='w-full my-4 bg-green-500 text-white hover:bg-green-600' type='submit'>Sign Up</Button>}
          <span className='text-sm flex items-center justify-center'>Already have an account? <Link to='/login' className='text-blue'>Login</Link></span>
        </form>
      </div>
  )
}
